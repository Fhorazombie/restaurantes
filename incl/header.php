...
<html class="loading" lang="es" data-textdirection="ltr">
  ...
  <head>
    ...
    <title><?php echo substr(strtoupper($_SERVER['REQUEST_URI']), 1); ?> | Webstaurant </title>
      ...
      <div class="navbar-wrapper">
        ...
        <div class="navbar-header">
          ...
          <ul class="nav navbar-nav flex-row">
            ...
            <li class="nav-item"><a class="navbar-brand" href="../dashboard"><img class="brand-logo" alt="modern admin logo" src="../../../app-assets/images/logo/logo-dark.png" style="
        ...
        <div class="navbar-container content">
          ...
          <div class="collapse navbar-collapse" id="navbar-mobile">
            ...
            <ul class="nav navbar-nav mr-auto float-left">
              ...
              <li class="dropdown nav-item mega-dropdown"><a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown">Webstaurant</a>
            ...
            <ul class="nav navbar-nav float-right">
              ...
              <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown"><span class="mr-1">Hola,<span class="user-name text-bold-700"><?php echo $_SESSION["nombre"]; ?></span></span><span class="avatar avatar-online"><img src="../../../app-assets/images/portrait/small/avatar-s-19.png" alt="avatar"><i></i></span></a>
                ...
                <div class="dropdown-menu dropdown-menu-right">
                  ...
                  <a class="dropdown-item" href="../usuarios_admin/?id=<?php echo $_SESSION["id"]; ?>"><i class="ft-user"></i>Editar perfil</a>



                  <div class="dropdown-divider"></div><a class="dropdown-item" href="../incl/logout.php"><i class="ft-power"></i> Cerrar sesion</a>
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true">
      ...
      <div class="main-menu-content">
        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          ...
          <li ><a href="../dashboard"><i class="la la-home"></i><span class="menu-title" data-i18n="">Panel de inicio</span></a>
          ...
          <li class=" nav-item"><a href="#"><i class="la la-cutlery"></i><span class="menu-title" data-i18n="">Restaurantes</span></a>
            ...
            <ul class="menu-content">
              ...
              <li><a class="menu-item" href="../restaurantes">Lista de restaurantes</a>
              ...
              <li><a class="menu-item" href="../restaurantes_admin">Agregar restaurante</a>
          ...
          <li class=" nav-item"><a href="#"><i class="la la-users"></i><span class="menu-title" data-i18n="">Usuarios</span></a>
            ...
            <ul class="menu-content">
              ...
              <li><a class="menu-item" href="../usuarios">Todos los usuarios</a>
              ...
              <li><a class="menu-item" href="../usuarios_admin">Agregar usuario</a>
